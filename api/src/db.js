...
const sequelize = new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/compras`, {
...
const { Model, Purchase, User } = sequelize.models;

// Aca vendrian las relaciones
// Product.hasMany(Reviews);
// Model.hasMany(Purchase);
// Purchase.belongsTo(Model);
